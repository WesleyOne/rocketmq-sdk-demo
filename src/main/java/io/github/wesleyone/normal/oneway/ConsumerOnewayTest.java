 ...
 * Push方式
 */
public class ConsumerOnewayTest {

    public static void main(String[] args) {
        Properties properties = new Properties();
        // 您在控制台创建的Group ID。
        properties.put(PropertyKeyConst.GROUP_ID, "NormalOnewayGroupId");
        ...
        consumer.subscribe("NormalOnewayTopicTest", "TagA", new MessageListener() {
            @Override
